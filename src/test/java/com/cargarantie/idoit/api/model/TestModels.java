...
public class TestModels {
  public static void register() {
    ...
    AllModels.register("C__CATG__CUSTOM_FIELDS_CLIENT_DESCRIPTION", IdoitCategoryClientDescription.class);
    AllModels.register("C__OBJTYPE__CLIENT", IdoitObjectClientSimple.class);
    AllModels.register("C__OBJTYPE__CLIENT", IdoitObjectClient.class);
  }
}
